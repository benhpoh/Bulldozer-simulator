...
class Outside_Site_Test < MiniTest::Test
  def test_within_site_0_0
    ...
    actual = map.is_outside_site?(0,0)
    expected = false
  ...
  def test_within_site_2_2
    map = Map.new [["o","o","o"], ["o","o","o"], ["o","o","o"]]
    actual = map.is_outside_site?(2,2)
    expected = false
    assert_equal(expected, actual)
  end
  ...
  def test_outside_site_neg1_0
    map = Map.new [["o","o","o"], ["o","o","o"], ["o","o","o"]]
    actual = map.is_outside_site?(-1,0)
    expected = true
    assert_equal(expected, actual)
  end
  ...
  def test_outside_site_1_3
    map = Map.new [["o","o","o"], ["o","o","o"], ["o","o","o"]]
    actual = map.is_outside_site?(1,3)
    expected = true
    assert_equal(expected, actual)
  end
end

class Protected_Tree_Test < MiniTest::Test
  def test_protected_tree
    map = Map.new [["T","o","o"]]
    actual = map.is_protected_tree?(0,0)
    expected = true
    assert_equal(expected, actual)
  end
